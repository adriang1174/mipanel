...
<span style="cursor: pointer;" onclick="show_hide('action<!--{$action[3]}-->')">&nbsp;<img src="<!--{ipath name="bt-ampliar.gif" owner="1"}-->" border="0">&nbsp;</span><!--{$action[0]}--></td></tr>
		...
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr style="height: 25px">
				...
				<td width="80" style="padding-left: 5px;"><!--{lang k=ESTADO}-->:</td>
				<td style="padding-left: 5px;" width="200"><input type="text" disabled="disabled" name="enable" value="<!--{if $datos[0].enable eq 1}-->Activo<!--{else}-->Suspendido<!--{/if}-->"></td>
				<td>&nbsp;</td>
			</tr>
