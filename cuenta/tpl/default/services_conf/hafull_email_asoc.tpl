<tr style="height: 30px;"><td class="scr_resalt2"><span style="cursor: pointer;" onclick="show_hide('action<!--{$action[3]}-->'); return false;">&nbsp;&nbsp;&nbsp;<img src="<!--{ipath name="arrow.gif"}-->" border="0">&nbsp;&nbsp;</span><a href="#" class="popup_link" onclick="show_hide('action<!--{$action[3]}-->'); return false;"><!--{$action[0]}--></a></td></tr>
		...
		<div id="action<!--{$action[3]}-->" style="display: none;">
            ...
            <input type="hidden" name="Mail2" id="Mail2" size="45" value="<!--{$grid[0].Mail2|trim}-->"/>
            <input type="hidden" name="Mail3" id="Mail3" size="45" value="<!--{$grid[0].Mail3|trim}-->"/>
            <input type="hidden" name="MailFax" id="MailFax" size="45" value="<!--{$grid[0].MailFax|trim}-->"/>
			<tr style="height: 25px">
				<td width="20">&nbsp;</td>
				<td width="340"><!--{lang k=MAIL_ALT}--> </td>
				<td width="190"><input type="text" name="Mail1" id="Mail1" size="45" value="<!--{$grid[0].Mail1|trim}-->"/></td>
				<td>&nbsp;</td>
			</tr>
			<tr style="height: 25px">
				<td>&nbsp;</td>
				<td><!--{lang k=AVISO_MAIL_ALT}--></td>
				<td><input type="text" name="AvisoMail" id="AvisoMail" size="45" value="<!--{$grid[0].AvisoMail|trim}-->"/></td>
				<td>&nbsp;</td>
			</tr>	
