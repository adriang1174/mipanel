...
function showFollowme(){
	...
	window.open('fh_callback.ca?popup=1&followme=1&ani=<!--{$line}-->&id_accion=<!--{$action[3]}-->','popup','width=' + popW + ',height=' + popH + ',top=' + topPos + ',left=' + leftPos+',scrollbars=yes,resizable=yes');
}
</script>
		...
		<tr><td>
			<div id="action<!--{$action[3]}-->" style="display: none;">
				...
				<td width="20">&nbsp;</td>
				<td>
					<a href="#" onclick="showFollowme(); return false;"/><img src="<!--{ipath name="bt-vergrilla.gif" owner="1" lang="1"}-->" border="0"></a>
				</td>
				<td>&nbsp;</td>
				</tr>
				</table>
