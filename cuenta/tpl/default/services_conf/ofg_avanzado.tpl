...
function addAni(){
	...
	window.open('conf_services_popup.ca?popup=1&accion=ofg2_avanzado_nuevoani','popup','width=' + popW + ',height=' + popH + ',top=' + topPos + ',left=' + leftPos);
}
</script>
			...
			<table cellspacing="2" cellpadding="0" border="0" width="">
				<tr style="height: 20px">
					...
					<td class="scr_resalt" align="center" width="200">&nbsp;</td>
			...
			<form name="frmdelete" id="frmdelete" action="" method="post">	
             ...
             <form name="frmupdate" id="frmupdate" action="" method="post">
					...
					<td align="center"><input type="text" name="descripcion" value="<!--{$telef.descripcion}-->"/></td>
					<td align="center">
						<select name="actionupdate">
							<option value="0">- Seleccione una opci&oacute;n -</option>
							<option value="1" <!--{if $telef.accion == 1}--> selected="selected" <!--{/if}-->>Bloqueado
							<option value="3" <!--{if $telef.accion == 3}--> selected="selected" <!--{/if}-->>Contestador
						</select>
					</td>
                    <td align="center">
